...
if (NOT OGRE_ARCHIVE_OUTPUT)
  if(APPLE AND NOT OGRE_BUILD_PLATFORM_ANDROID)
    ...
    set(OGRE_ARCHIVE_OUTPUT ${OGRE_OUTPUT_ROOT}/lib)
  endif()
endif ()
...
function(ogre_config_common TARGETNAME)
  set_target_properties(${TARGETNAME} PROPERTIES
    ...
    ARCHIVE_OUTPUT_DIRECTORY_DEBUG "${OGRE_ARCHIVE_OUTPUT}/Debug/${OGRE_BUILD_PLATFORM_DIR}"
    ARCHIVE_OUTPUT_DIRECTORY_RELEASE "${OGRE_ARCHIVE_OUTPUT}/Release/${OGRE_BUILD_PLATFORM_DIR}"
    ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_ARCHIVE_OUTPUT}/RelWithDebInfo/${OGRE_BUILD_PLATFORM_DIR}"
    ARCHIVE_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_ARCHIVE_OUTPUT}/MinSizeRel/${OGRE_BUILD_PLATFORM_DIR}"
    LIBRARY_OUTPUT_DIRECTORY_DEBUG "${OGRE_LIBRARY_OUTPUT}/Debug/${OGRE_BUILD_PLATFORM_DIR}"
    LIBRARY_OUTPUT_DIRECTORY_RELEASE "${OGRE_LIBRARY_OUTPUT}/Release/${OGRE_BUILD_PLATFORM_DIR}"
    LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_LIBRARY_OUTPUT}/RelWithDebInfo/${OGRE_BUILD_PLATFORM_DIR}"
    LIBRARY_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_LIBRARY_OUTPUT}/MinSizeRel/${OGRE_BUILD_PLATFORM_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_DEBUG "${OGRE_RUNTIME_OUTPUT}/Debug/${OGRE_BUILD_PLATFORM_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_RELEASE "${OGRE_RUNTIME_OUTPUT}/Release/${OGRE_BUILD_PLATFORM_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_RUNTIME_OUTPUT}/RelWithDebInfo/${OGRE_BUILD_PLATFORM_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_RUNTIME_OUTPUT}/MinSizeRel/${OGRE_BUILD_PLATFORM_DIR}"
  )
